            ...
            <div className= {`info ${this.props.partitionSelected === "About Me" ? "info-transform" : "info-origin" }`}>
                <div className="">
                    ...
                    <div>
                        ...
                        <p className = "paragraph"> &emsp; &emsp; Whether it’s a movie or a board games, I am always down to hang out. I like everything sweet except chocolate or cake and I love rain. On a clear summer days, I love to hike, play backyard sports or play a fun table top RPG. </p>
                    </div>
                </div>
            </div>
            <div className= {`info ${this.props.partitionSelected === "Skills" ? "info-transform" : "info-origin" }`}>
                <div className="info-holder">
                    ...
                    <ul className= "skill-list">
                        ...
                        <li>MySQL & NoSQL databases</li>
                        <li>Unity Game Engine</li>
                        <li>Git</li>
                        <li>Clear verbal and written communication</li>
                        <li>Able to master new skills quickly</li>
                    </ul>
                    <div className="link">
            ...
            <div className= {`info ${this.props.partitionSelected === "Education" ? "info-transform" : "info-origin" }`}>
                <div className="info-holder border-top">
                    ...
                    <div className = "border-top">
                        ...
                        <h2>2020</h2>
                        <p className="paragraph">Full stack wed development bootcamp where I learned and mastered. HTML, CSS, JavaScript, JQuery, React, MySQL, NoSQL with a mobile-first responsive design. </p>
                    </div>
                    <div className = "border-top">
                        <h2>Liberty University</h2>
                        <h2>Bachelor of Music Commercial Music: Film Scoring </h2>
                        <h2>2017</h2>
                        <p className="paragraph">Libral arts degree where I studied music and sound with an emphasis on excellent user experience and prefessional media</p>
                    </div>
                </div>
            </div>  
